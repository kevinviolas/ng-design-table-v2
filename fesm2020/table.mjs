...
import { EventEmitter, Injectable, Inject, Component, Input, ViewChild, NgModule, ViewEncapsulation, Output, Optional, SkipSelf } from '@angular/core';
...
import * as i1$3 from 'nowboard-icon';
...
class CollabMenuComponent {
    constructor() { }
    ngOnInit() {
    }
}
CollabMenuComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.8", ngImport: i0, type: CollabMenuComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
CollabMenuComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.3.8", type: CollabMenuComponent, selector: "lib-collab-menu", ngImport: i0, template: "<!--<nb-icon [matMenuTriggerFor]=\"menu\" [icon]=\"'menu_kebab'\" [size]=\"1.5\"></nb-icon>-->\n\n<mat-menu class=\"collab-menu\" #menu=\"matMenu\">\n    <button mat-menu-item>\n        <!--<nb-icon [icon]=\"'information_circle'\" [size]=\"1.5\"></nb-icon>-->\n        <span>D\u00E9tail</span>\n    </button>\n    <button mat-menu-item>\n        <!--<nb-icon [icon]=\"'edit_1'\" [size]=\"1.5\"></nb-icon>-->\n        <span>Modifier</span>\n    </button>\n    <button mat-menu-item>\n        <!--<nb-icon [icon]=\"'display_1'\" [size]=\"1.5\"></nb-icon>-->\n        <span>Assigner un \u00E9quipement</span>\n    </button>\n    <button class=\"menu-red\" mat-menu-item>\n        <!--<nb-icon [primary]=\"'#F6544C'\" [icon]=\"'delete_1'\" [size]=\"1.5\"></nb-icon>-->\n        <span>Supprimer</span>\n    </button>\n</mat-menu>", styles: [""], components: [{ type: i1$2.MatMenu, selector: "mat-menu", exportAs: ["matMenu"] }, { type: i1$2.MatMenuItem, selector: "[mat-menu-item]", inputs: ["disabled", "disableRipple", "role"], exportAs: ["matMenuItem"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.8", ngImport: i0, type: CollabMenuComponent, decorators: [{
            type: Component,
            args: [{ selector: 'lib-collab-menu', template: "<!--<nb-icon [matMenuTriggerFor]=\"menu\" [icon]=\"'menu_kebab'\" [size]=\"1.5\"></nb-icon>-->\n\n<mat-menu class=\"collab-menu\" #menu=\"matMenu\">\n    <button mat-menu-item>\n        <!--<nb-icon [icon]=\"'information_circle'\" [size]=\"1.5\"></nb-icon>-->\n        <span>D\u00E9tail</span>\n    </button>\n    <button mat-menu-item>\n        <!--<nb-icon [icon]=\"'edit_1'\" [size]=\"1.5\"></nb-icon>-->\n        <span>Modifier</span>\n    </button>\n    <button mat-menu-item>\n        <!--<nb-icon [icon]=\"'display_1'\" [size]=\"1.5\"></nb-icon>-->\n        <span>Assigner un \u00E9quipement</span>\n    </button>\n    <button class=\"menu-red\" mat-menu-item>\n        <!--<nb-icon [primary]=\"'#F6544C'\" [icon]=\"'delete_1'\" [size]=\"1.5\"></nb-icon>-->\n        <span>Supprimer</span>\n    </button>\n</mat-menu>", styles: [""] }]
        }], ctorParameters: function () { return []; } });
...
TableModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.3.8", ngImport: i0, type: TableModule, declarations: [TableComponent,
        ...
        RouterModule,
        MatBadgeModule,
        MatMenuModule, i1$3.NowboardIconModule], exports: [TableComponent,
        CustomerRankComponent,
        DateFormatComponent,
        EquipementStatusComponent,
        EquipementTypeComponent,
