...
import * as i1$2 from 'nowboard-icon';
...
TableModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.3.8", ngImport: i0, type: TableModule, declarations: [TableComponent,
        ...
        RouterModule,
        MatBadgeModule,
        MatMenuModule, i1$2.NowboardIconModule], exports: [TableComponent,
        CustomerRankComponent,
        DateFormatComponent,
        EquipementStatusComponent,
        EquipementTypeComponent,
