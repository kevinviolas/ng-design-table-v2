...
PriorityComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.3.8", type: PriorityComponent, selector: "icon-priority", inputs: { icon: "icon", iconLabel: "iconLabel" }, usesOnChanges: true, ngImport: i0, template: "<!--<png-icon matTooltip=\"{{this.iconLabel}}\" [src]=\"this.iconSrc\"></png-icon>-->\n<!--<png-icon [src]=\"this.iconSrc\"></png-icon>-->\n<span matTooltip=\"{{this.label}}\" class=\"{{this.iconSrc}}\">\n    {{this.label}}\n</span>", styles: [".now-low{background-color:#00bc8e;border-radius:1000px;border:none!important;text-align:left;color:#fff;font: 14px/36px Nexa Text;letter-spacing:0px;padding:8px 19px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px;text-align:center}.now-normal{background-color:#169d8a;border-radius:1000px;border:none!important;text-align:left;font: 14px/36px Nexa Text;letter-spacing:0px;color:#fff;padding:8px 19px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px;text-align:center}.now-urgent{background-color:#c48e3b;border-radius:1000px;border:none!important;text-align:left;font: 14px/36px Nexa Text;letter-spacing:0px;color:#fff;padding:8px 19px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px;text-align:center}.now-critic{background:no-repeat padding-box rgba(215,5,43,.56)!important;border-radius:1000px;border:none!important;text-align:left;font: 14px/36px Nexa Text;letter-spacing:0px;color:#fff;padding:8px 19px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px;text-align:center}.now-vip{background:no-repeat padding-box rgba(120,125,130,.56)!important;border-radius:1000px;border:none!important;text-align:left;font: 12px/36px Nexa Text;letter-spacing:0px;color:#fff;padding:8px 19px;overflow:hidden;white-space:nowrap;max-width:80px!important;text-overflow:ellipsis;display:inline-block;height:36px;text-align:center}\n"], directives: [{ type: i3.MatTooltip, selector: "[matTooltip]", inputs: ["matTooltipShowDelay", "matTooltipHideDelay", "matTooltipTouchGestures", "matTooltipPosition", "matTooltipDisabled", "matTooltip", "matTooltipClass"], exportAs: ["matTooltip"] }] });
